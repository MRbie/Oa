...
<SCRIPT LANGUAGE="javascript" SRC="${basePath }resource/script/pageCommon.js"></SCRIPT>

<!--  
<SCRIPT LANGUAGE="javascript" SRC="${basePath }resource/script/general.js"></SCRIPT>
-->

<LINK HREF="${basePath }resource/style/blue/cn_mainWin.css" type=text/css  media=screen rel=stylesheet />
<LINK HREF="${basePath }resource/style/blue/query.css" type=text/css  media=screen rel=stylesheet />
<LINK HREF="${basePath }resource/style/blue/comm_mainWin.css" type=text/css  media=screen rel=stylesheet />
<LINK HREF="${basePath }resource/style/blue/selectPerson.css" REL="stylesheet" TYPE="text/css" />
<BASE TARGET="_self" />
<SCRIPT TYPE="text/javascript">
var basePath = "../";
function menuClick( sn ){
	$("div[id^=module_]").hide();
	$("li[id^=li_]>span>img").attr("src", basePath + "${basePath }resource/style/images/arrow_close.gif");
	
	$("div[id=module_" + sn + "]").show();
	$("li[id=li_"+sn+"]>span>img").attr("src", basePath + "${basePath }resource/style/images/arrow_open.gif");
}
...
<DIV ID=Title_bar>
    <DIV ID=Title_bar_Head>
        ...
        <DIV ID=Title>
            <!--页面标题-->
            <IMG BORDER="0" WIDTH="13" HEIGHT="13" SRC="${basePath }resource/style/images/title_arrow.gif" /> 选择人员 </DIV>
            ...
            <DIV CLASS="InsideBorder">
                <DIV CLASS="OperateArea">
                    <DIV ID="SearchInputArea">
                        ...
                        <IMG BORDER="0" SRC="${basePath }resource/style/images/search.gif" ID="search_icon"/> </DIV>
                    <DIV ID="ItemListArea">
                        <UL>
                            <LI ID="li_1"><SPAN onClick="menuClick(1);"><IMG border=0 src="${basePath }resource/style/images/arrow_close.gif"/> 所有人员列表</SPAN>
