...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${basePath }resource/style/images/title_arrow.gif"/> 用户信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="user_update" namespace="/" method="post">
    	<!-- 修改的隐藏用户id -->
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                            ...
                            <s:select name="departmentId" list="treeList" listKey="departmentId" listValue="departmentName" headerKey="" headerValue="请选择部门" cssClass="SelectStyle"></s:select> 
                        </td>
                    </tr>
                    <tr><td>登录名</td>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${basePath }resource/style/blue/images/item_point.gif" /> 岗位设置 </div> 
        </div>
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                            ...
                            <s:select name="roleIds" list="roleList" listKey="roleId" listValue="roleName" multiple="true" size="10" cssClass="SelectStyle"></s:select>
