...
<title>配置权限</title>
	...
	<script language="javascript" src="${basePath }resource/script/jquery_treeview/jquery.treeview.js"></script>
	<link type="text/css" rel="stylesheet" href="${basePath }resource/style/blue/file.css" />
	<link type="text/css" rel="stylesheet" href="${basePath }resource/script/jquery_treeview/jquery.treeview.css" />
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${basePath }resource/style/images/title_arrow.gif"/> 配置权限
        </div>
...
<div id=MainArea>
    <form action="list.html">
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${basePath }resource/style/blue/images/item_point.gif" /> 正在为【部门经理】配置权限 </div> 
        </div>
